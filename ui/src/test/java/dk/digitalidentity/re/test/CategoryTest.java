...
public class CategoryTest {
	...
	public void create() {
		...
		WebElement createButton = driver.findElement(By.id("addCategoryButton"));
		createButton.click();
		
		WebElement modal = driver.findElement(By.id("addCategoryModal"));
	...
	private void removeTestData() {
		...
		Optional<Category> toBeDelete = categories.stream().filter(d -> d.getName().startsWith(testName)).findAny();
		
		if (toBeDelete.isPresent()) {
			categoryDao.delete(toBeDelete.get());
		}
	}
	...
	public void tryEdit() {
		...
		WebElement modal = driver.findElement(By.id("editCategoryModal"));
		wait.until(ExpectedConditions.visibilityOf(modal));
		Assert.assertTrue(modal.isDisplayed());
