...
public class LoginService {
	...
	public ChromeDriver login() {
		...
		initDriver();
		driver.get(url + "/saml/login");

		if (driver.getCurrentUrl().startsWith(url + "/saml/discovery")) {
			WebElement loginButton = driver.findElement(By.id("loginBtn"));
			loginButton.click();
		}

		if (driver.getTitle().equals("Sign In")) {
			WebElement usernameInputBox = driver.findElement(By.id("userNameInput"));
			WebElement passwordInputBox = driver.findElement(By.id("passwordInput"));
